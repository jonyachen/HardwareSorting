//=========================================================================
// Test for SsortUnitComb
//=========================================================================

`include "ssort-SsortUnitComb.v"
...
module ssort_SsortUnitComb_helper
(
input  clk,
input  reset,
output done
...
wire [127:0] sink_msg;
wire [31:0] sink_result_a;
wire [31:0] sink_result_b;
wire [31:0] sink_result_c;
wire [31:0] sink_result_d;
wire        sink_val;
wire        sink_rdy;
wire        sink_done;
